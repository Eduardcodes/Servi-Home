describe('User should be able to add new revitalize rug service', () => {
  ...
  it('Rug service', () => {
    ...
    cy.log('User should be able to se details of his book');
    cy.contains('h3', 'data-cy="selected-title-service"');
    // cy.contains('h3[data-cy="selected-title-service"]');
    // cy.contains('p[data-cy="selected-measure-service"]');
    // cy.contains('p[data-cy="selected-seat-service"]');
    // cy.contains('p[data-cy="selected-condition-rug-service"]');
    // cy.contains('p[data-cy="selected-condition-service"]');
    // cy.contains('p[data-cy="selected-material-service"]');
    // cy.contains('p[data-cy="selected-services-service"]');
