describe('using the app as a cleaner', () => {
  it('can sign up new cleaner user', () => {
    ...
    cy.get('[data-cy="cleaner-signup-submit"]')
      .click()
})
  it('can login existing cleaner users', ()=> {
    cy.visit('http://localhost:3002')
    
    cy.get('[data-cy="cleaner-signup"]')
      .click()

    cy.get('[data-cy="cleaner-existing-user"]')
      .click()
    ...
    cy.get('[data-cy="cleaner-login-submit"]')
      .click()

    cy.get('[data-cy="accept-booking-button"]')
      .click()
